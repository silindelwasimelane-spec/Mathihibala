...
const loadSessions = () => {
  ...
  const saved = JSON.parse(localStorage.getItem(storageKey(currentUser.username)) || '[]');
...
const saveSession = (session) => {
  ...
  localStorage.setItem(storageKey(currentUser.username), JSON.stringify([session, ...sessions]));
};
